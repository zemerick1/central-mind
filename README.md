...
CentralMind takes that same approach and applies it to **HPE Aruba Networking Central, HPE Juniper Mist, HPE Networking Security Director Cloud, and HPE Aruba Clearpass**, which have their own challenges:
...
└──────────────┬──────────────────────┬───────────────────────┘
    ...
    spec/*.resolved.json          Aruba Central, Mist,
         (Local specs)            Clearpass, SDC APIs
```
